        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#lost" className="text-muted-foreground hover:text-primary transition-colors">
                  Browse Lost Items
                </a>
              </li>
              <li>
                <a href="#found" className="text-muted-foreground hover:text-primary transition-colors">
                  Browse Found Items
                </a>
              </li>
              <li>
